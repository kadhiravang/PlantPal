...
if selection == "🌞 Indoor Plant Recommender":
    ...
    image = st.file_uploader("Upload room image", type=["jpg", "jpeg", "png"])
...
# ---------------------- 2. Outdoor Growth Advisor ----------------------
    ...
    image = st.file_uploader("Upload an outdoor space image (balcony, terrace)", type=["jpg", "jpeg", "png"])
...
# ---------------------- 3. Health & Reminder System ----------------------
    ...
    image = st.file_uploader("📸 Upload a photo of your plant", type=["jpg", "jpeg", "png"])
    ...
    with st.container():
        ...
        for plant in plants:
            ...
            with st.expander(f"🌱 {name}"):
                ...
                new_image = st.file_uploader(f"Upload new image for {name}", type=["jpg", "jpeg", "png"], key=f"new_image_{plant_id}")
                if new_image:
